...
`go-ruby-money/money` reimplements Ruby's `money` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-money/money` directly, with no Ruby runtime;
