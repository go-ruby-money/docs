...
Contributions are welcome. `go-ruby-money/money` is built to a small set of
...
The library is in [`github.com/go-ruby-money/money`](https://github.com/go-ruby-money/money).
This documentation site is in [`github.com/go-ruby-money/docs`](https://github.com/go-ruby-money/docs).
