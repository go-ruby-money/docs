...
The public API lives at the module root (`github.com/go-ruby-money/money`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `money`, while the surface follows
...
```go
import "github.com/go-ruby-money/money"
```
...
- **[pkg.go.dev/github.com/go-ruby-money/money](https://pkg.go.dev/github.com/go-ruby-money/money)**

The module's [README](https://github.com/go-ruby-money/money#readme) carries worked
