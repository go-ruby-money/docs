# go-ruby-money documentation

**Pure-Go, MRI-faithful Ruby money (no cgo)**

`go-ruby-money/money` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `money`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `money`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`money`](https://github.com/go-ruby-money/money) | the library — Ruby's `money` in pure Go |
| [`docs`](https://github.com/go-ruby-money/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-money.github.io`](https://github.com/go-ruby-money/go-ruby-money.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-money/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-money/money](https://github.com/go-ruby-money/money).
